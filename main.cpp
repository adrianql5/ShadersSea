    ...
    #include "mar.h" // Incluir el archivo de cabecera del mar
    ...
    Objeto terreno = { {0, 0, 0}, 0, {2000, 0, 2000}, {0, 0.1875, 0.3046}, 0, 0,36,0};
    Objeto barco = { {200, 0.6, 0.0}, 0.25, {0.2, 0.2, 0.9}, {1, 0, 0}, 0,0,29310,10};
	Objeto barco2 = { {200, 0.6, 0.0}, 0.25, {.000001, .00001, .00001}, {1, 0, 0}, 0,0,29310,10};
    ...
    void iluminacion() {
        ...
        glUniform3f(lightLoc, .3f, 0.3f, 0.3f);
    ...
    void display() {  
        ...
        unsigned int transformLocBarco = glGetUniformLocation(shadersBarco, "model");
        unsigned int colorLocBarco = glGetUniformLocation(shadersBarco, "objectoColor");
    ...
    int main(int argc, char** argv) {  
       ...
       crearObjeto("resources/Boat.obj", barco, "resources/textures/boat_diffuse.bmp");
       ...
       //// Asociar los shaders a los objetos
    ...
    void processInput(GLFWwindow* window) {  
		...
		if (glfwGetKey(window, GLFW_KEY_X) == GLFW_PRESS && !keyPressed) {  
			keyPressed = true;  
			lanzarProyectil(proyectil1.VAO,cameraPos, vectorDirectorCamara, barcosActivos, proyectilesActivos, VELOCIDAD_PROYECTIL);  
			printf("Lanzar proyectil\n");  
		}  
